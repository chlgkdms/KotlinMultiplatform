...
__attribute__((swift_name("GithubDataSource")))
@interface SharedGithubDataSource : SharedBase
...
*/
- (void)getGithubUsersUserName:(NSString *)userName completionHandler:(void (^)(SharedGithubUsersModel * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getGithubUsers(userName:completionHandler:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GithubUserModel")))
@interface SharedGithubUserModel : SharedBase
- (instancetype)initWithFullName:(NSString *)fullName avatarUrl:(NSString * _Nullable)avatarUrl __attribute__((swift_name("init(fullName:avatarUrl:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedGithubUserModelCompanion *companion __attribute__((swift_name("companion")));
- (SharedGithubUserModel *)doCopyFullName:(NSString *)fullName avatarUrl:(NSString * _Nullable)avatarUrl __attribute__((swift_name("doCopy(fullName:avatarUrl:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GithubUserModel.Companion")))
@interface SharedGithubUserModelCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedGithubUserModelCompanion *shared __attribute__((swift_name("shared")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GithubUsersModel")))
@interface SharedGithubUsersModel : SharedBase
- (instancetype)initWithItems:(NSArray<SharedGithubUserModel *> *)items __attribute__((swift_name("init(items:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedGithubUsersModelCompanion *companion __attribute__((swift_name("companion")));
- (SharedGithubUsersModel *)doCopyItems:(NSArray<SharedGithubUserModel *> *)items __attribute__((swift_name("doCopy(items:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedGithubUserModel *> *items __attribute__((swift_name("items")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GithubUsersModel.Companion")))
@interface SharedGithubUsersModelCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedGithubUsersModelCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
- (void)getGithubUsersUserName:(NSString *)userName completionHandler:(void (^)(SharedGithubUsersModel * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getGithubUsers(userName:completionHandler:)")));
- (NSString *)getSavedString __attribute__((swift_name("getSavedString()")));
- (void)saveStringString:(NSString *)string __attribute__((swift_name("saveString(string:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("StringDataSource")))
@interface SharedStringDataSource : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) SharedStringDataSourceCompanion *companion __attribute__((swift_name("companion")));
- (NSString *)getSavedString __attribute__((swift_name("getSavedString()")));
- (void)saveStringString:(NSString *)string __attribute__((swift_name("saveString(string:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("StringDataSource.Companion")))
@interface SharedStringDataSourceCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedStringDataSourceCompanion *shared __attribute__((swift_name("shared")));
@end
